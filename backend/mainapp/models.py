...
class CartProduct(models.Model):
    ...
    user = models.ForeignKey('Custumer', on_delete=models.CASCADE, verbose_name='Покупатель')
...
class Cart(models.Model):
    ...
    owner = models.ForeignKey('Custumer', on_delete=models.CASCADE, verbose_name='Владелец')
